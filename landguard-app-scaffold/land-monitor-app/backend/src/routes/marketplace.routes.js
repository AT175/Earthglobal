...
router.post('/listings/:id/purchase', requireAuth, ctrl.initiatePurchase);
...
// ═══════════════════════════════════════════════════════════
router.post('/listings', requireAuth, requireRole('owner'), ctrl.createListing);
...
router.post('/purchases/:id/transfer-ownership', requireAuth, requireRole('owner'), ctrl.transferOwnership);
